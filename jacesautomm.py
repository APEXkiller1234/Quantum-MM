...
YOUR_USER = 0 # Your User ID
TOS_CHANNEL = 0 # Middleman ToS Channel ID
MM_TOS_CHANNEL = 0 # Auto Middleman ToS Channel ID
TICKET_CATEGORY = 0 # Auto Middleman Tickets Category ID
TRANSCRIPT_CHANNEL = 0 # Auto Middleman Tickets Logging Channel ID
COMPLETED_TRANSACTION_CHANNEL = 0 # Completed Auto Middleman Embeds Channel ID
SETTLEMENT_CHANNEL = 0
DEMO_COMPLETED_TRANSACTION_CHANNEL = 0 # Must be different from COMPLETED_TRANSACTION_CHANNEL
TUTORIAL_URL = "https://www.youtube.com/watch?v=XIkpcT2WNPI" # For Tutorial Button in Panel

LTC_DEPOSIT_ADDRESS = "" # Your Litecoin Address
USDT_DEPOSIT_ADDRESS = "" # Your USDT Address

BLOCKCYPHER_TOKEN = "" # Get from https://www.blockcypher.com/apis.html
ETHERSCAN_API_KEY = "" # Get from https://etherscan.io/api
...
LTC_EMOJI = "" # Saved as ltcemoji.webp
USDT_EMOJI = "" # Saved as usdtemoji.webp
ANIMATED_X_EMOJI = "" # Saved as xtickemoji.webp
ANIMATED_WAVE_EMOJI = "" # Saved as waveemoji.webp
ROLE_SHIELD_EMOJI = "" # Saved as roleshieldemoji.webp
BLUE_LOADING_EMOJI = "" # Saved as greentickemoji.webp
GREEN_TICK_EMOJI = "" # Saved as greentickemoji.webp
LOAD_EMOJI = "" # Saved as loademoji.webp
